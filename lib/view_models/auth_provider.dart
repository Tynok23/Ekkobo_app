...
class AuthProvider extends ChangeNotifier {
  ...
  void selectState(String? state) {
    ...
    _selectedLGA = null; // Reset the LGA when the state changes
    _lgas = stateLGAMap[state] ?? [];
    notifyListeners();
  }

  // Setter for selected LGA
  void selectLGA(String? lga) {
    _selectedLGA = lga;
    notifyListeners();
  }
    void selectGend(String? gender) {
